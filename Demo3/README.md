...
- **`reader.py`** : reader process
- **`writer.py`** : writer process
...
### Utils Folder
- **`account.py`** : utility functions for account management
- **`transaction.py`** : utility functions for handling transactions
